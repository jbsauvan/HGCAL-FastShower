try:
    # Standalone imports
    from geometry_hexagon_small_cfg import *
    from shower_cfg import *
    from generation_cfg import *
    from display_cfg import *
    from generation_utils import shoot_cell_vertex
except ImportError:
    # CMSSW imports
    from HGCalSimulation.FastShower.geometry_hexagon_small_cfg import *
    ...
    from HGCalSimulation.FastShower.generation_utils import shoot_cell_vertex

events = 1000
debug = False
output_file = 'output/hexagons_small_vertex.root'

generation_noise = False
generation_incident_eta, generation_incident_phi = \
shoot_cell_vertex(eta=2.0, phi=0., vertex_number=0,
                  # geometry window
