try:
    ...
    from generation_utils import shoot_cell_edge
except ImportError:
    # CMSSW imports
    ...
    from HGCalSimulation.FastShower.generation_utils import shoot_cell_edge

events = 1000
debug = False
output_file = 'output/hexagons_small_edge.root'
